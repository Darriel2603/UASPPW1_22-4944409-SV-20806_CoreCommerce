        ...
        <div class="row">
            <div class="col-md-12">
                <?php if(!isset($_SESSION['cart_p_id'])): ?>
                    <?php echo '<h2 class="text-center">Your cart is currently empty.</h2></br>'; ?>
                    <?php echo '<h4 class="text-center">To view your cart, please add products to it</h4>'; ?>
                <?php else: ?>
                ...
                <div class="cart">
                    <table class="table table-responsive table-hover table-bordered">
                        <tr>
                            ...
                            <th class="text-center" style="width: 100px;"><?php echo LANG_VALUE_83; ?></th></th>
                        </tr>
                        <?php
                        $table_total_price = 0;
                        ...
                        <td><?php echo $i; ?></td>
                        <td>
                            <img src="assets/uploads/<?php echo $arr_cart_p_featured_photo[$i]; ?>" alt="">                            </td>
